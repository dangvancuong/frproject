<section class="popular">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                <div class="food-item-wrap">
                    <div class="figure-wrap bg-image" data-image-src="{{ asset('pages/assets/images/food1.jpg')}}">
                    ...
                    <div class="restaurant-block">
                        <div class="left">
                            <a class="pull-left" href="profile.html"> <img src="{{ asset('pages/assets/images/logo1.png') }}" alt="Restaurant logo" /> </a>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                <div class="food-item-wrap">
                    <div class="figure-wrap bg-image" data-image-src="src="{{ asset('pages/assets/images/food2.jpg')}}">
                    <div class="distance"><i class="fa fa-pin"></i>1240m</div>
                    <div class="rating pull-left"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div>
                    <div class="review pull-right"><a href="#">198 reviews</a> </div>
                </div>
                ...
                <div class="restaurant-block">
                    <div class="left">
                        <a class="pull-left" href="profile.html"> <img src="{{ asset('pages/assets/images/logo2.png') }}" alt="Restaurant logo" /> </a>
                        <div class="pull-left right-text"> <a href="#">Chicken Restaurant</a> <span>68 5th Avenue New York</span> </div>
                    </div>
                    <div class="right-like-part pull-right"> <i class="fa fa-heart-o"></i> <span>48</span> </div>
                </div>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 food-item">
            <div class="food-item-wrap">
                <div class="figure-wrap bg-image" data-image-src="{{ asset('pages/assets/images/food3.jpg')}}">
                    <div class="distance"><i class="fa fa-pin"></i>1240m</div>
                    <div class="rating pull-left"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div>
                    <div class="review pull-right"><a href="#">198 reviews</a> </div>
                </div>
                ...
                <div class="restaurant-block">
                    <div class="left">
                        <a class="pull-left" href="profile.html"> <img src="{{ asset('pages/assets/images/logo3.png') }}" alt="Restaurant logo" /> </a>
                        <div class="pull-left right-text"> <a href="#">Chicken Restaurant</a> <span>68 5th Avenue New York</span> </div>
                    </div>
                    <div class="right-like-part pull-right"> <i class="fa fa-heart-o"></i> <span>48</span> </div>
                </div>
